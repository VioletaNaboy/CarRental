import{R as p,b as F,c as C,s as o,d as v,j as e,l as x,u as R,r as g,e as M,g as P}from"./index-e67c858b.js";function b(t=p){const s=t===p?F:C(t);return function(){const{store:a}=s();return a}}const E=b();function B(t=p){const s=t===p?E:b(t);return function(){return s().dispatch}}const S=B(),I=o.ul`
display: flex;
flex-wrap: wrap; 
